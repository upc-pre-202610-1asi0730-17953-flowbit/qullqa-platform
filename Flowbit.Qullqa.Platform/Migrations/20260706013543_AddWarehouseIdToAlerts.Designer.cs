...
namespace Flowbit.Qullqa.Platform.Migrations
{
    ...
    [Migration("20260706013543_AddWarehouseIdToAlerts")]
    partial class AddWarehouseIdToAlerts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowbit.Qullqa.Platform.Alerts.Domain.Model.Aggregates.Alert", b =>
                {
                    ...
                    b.HasIndex("WarehouseId")
                        .HasDatabaseName("ix_alerts_warehouse_id");
            ...
            modelBuilder.Entity("Flowbit.Qullqa.Platform.Alerts.Domain.Model.Aggregates.Alert", b =>
                {
                    ...
                    b.HasOne("Flowbit.Qullqa.Platform.Products.Domain.Model.Aggregates.Warehouse", null)
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_alerts_warehouse_warehouse_id");
                });
